...
class GeomMultiController : public GeomControllerBase< hardware_interface::JointHandle, UndercarriageCtrl>,
...
public:
    virtual bool init(hardware_interface::RobotHW* robot_hw, ros::NodeHandle &root_nh, ros::NodeHandle& controller_nh){
        std::vector<UndercarriageCtrl::WheelParams> wheel_params;
